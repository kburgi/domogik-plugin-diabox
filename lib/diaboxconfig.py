...
st_mathieu={}
st_mathieu["dev_type"]="diabox.st_mathieu"  #domogik json id
...
camping_abers={}
camping_abers["dev_type"]="diabox.camping_abers"  #domogik json id
camping_abers["name"]="Camping des Abers"
camping_abers["rid"]="101"
...
CN_plougerneau={}
CN_plougerneau["dev_type"]="diabox.cn_plougerneau"  #domogik json id
CN_plougerneau["name"]="CN Plougerneau"
CN_plougerneau["rid"]="109"
...
CN_guisseny={}
CN_guisseny["dev_type"]="diabox.cn_guisseny"  #domogik json id
...
st_cast={}
st_cast["dev_type"]="diabox.st_cast"  #domogik json id
st_cast["name"]="St-Cast-le-Guildo"
st_cast["rid"]="108"
...
ifremer_cersat={}
ifremer_cersat["dev_type"]="diabox.ifremer_cersat"  #domogik json id
ifremer_cersat["name"]="IFREMER CERSTAT"
ifremer_cersat["rid"]="13"
...
st_anne={}
st_anne["dev_type"]="diabox.st_anne"  #domogik json id
st_anne["name"]="Digue St-Anne"
st_anne["rid"]="14"
...
port_la_foret={}
port_la_foret["dev_type"]="diabox.port_la_foret" #domogik json id
port_la_foret["name"]="Port-La-Foret"
port_la_foret["rid"]="100"
...
glenan["name"]="Archipel de Glénan"
glenan["rid"]="106"
...
marseille_pacific_palissades["dev_type"]="diabox.marseille_pacific"  #domogik json id
marseille_pacific_palissades["name"]="CN Marseille Pacific-Palissades Glissattitude"
marseille_pacific_palissades["rid"]="105"
...
#            self.station_rid = cfg["rid"]   # This is remote id, on diabox website !
            ...
            if cfg["pressure"] != "":
                self.sensors_url["pressure"] = self.get_remote_url(cfg["rid"], cfg["pressure"])
               
            if cfg["wind_speed_kts"] != "":
                self.sensors_url["wind_speed_kts"] = self.get_remote_url(cfg["rid"], cfg["wind_speed_kts"])
                
            if cfg["wind_direction"] != "":
                self.sensors_url["wind_direction"] = self.get_remote_url(cfg["rid"], cfg["wind_direction"])

            if cfg["humidity"] != "":
                self.sensors_url["humidity"] = self.get_remote_url(cfg["rid"], cfg["humidity"])

            if cfg["rain_rate"] != "":
                self.sensors_url["rain_rate"] = self.get_remote_url(cfg["rid"], cfg["rain_rate"])
